...
public class InitScript : MonoBehaviour
{
    ...
    public static int DreamLivesCount = 2;
    ...
    void Awake()
    {
     ...
     //   Application.logMessageReceived += ExceptionHandler.This.HandleException;
        ...
        // DreamLivesCount = PlayerPrefs.GetInt("DreamLives");
    ...
    public void SpendDreamLives(int count)
    {
        if (DreamLivesCount > 0)
        {
            DreamLivesCount -= count;
            PlayerPrefs.SetInt("DreamLives", DreamLivesCount);
        }
    }
