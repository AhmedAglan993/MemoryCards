...
public class Square : MonoBehaviour
{
    ...
    Hashtable FindMoreMatches(int spr_COLOR, Hashtable countedSquares, FindSeparating separating, Hashtable countedSquaresGlobal = null)
    {
        ...
        if (this.item.color == spr_COLOR && !countedSquares.ContainsValue(this.item) && this.item.currentType != ItemsTypes.INGREDIENT && this.item.currentType != ItemsTypes.ANAMASRY && item.currentType != ItemsTypes.BOMB)
        {  //2.0
