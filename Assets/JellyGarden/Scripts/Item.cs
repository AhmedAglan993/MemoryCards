...
public class Item : MonoBehaviour
{
    ...
    public void GenColor(int exceptColor = -1, bool onlyNONEType = false)
    {
        ...
        /* foreach (var item in remainColors)
         {
             print("Remains Colors" + item.ToString());
        ...
        {
            print(LevelManager.THIS.ingrCountTarget[0]);
            int i = 0;
        ...
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[0] == ANAMASRY.A || LevelManager.THIS.trip[0] == ANAMASRY.N || LevelManager.THIS.trip[0] == ANAMASRY.M || LevelManager.THIS.trip[0] == ANAMASRY.S || LevelManager.THIS.trip[0] == ANAMASRY.R || LevelManager.THIS.trip[0] == ANAMASRY.Y))
                 && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
                 && LevelManager.THIS.GetMasry(0).Count < LevelManager.THIS.AnaMasryCountTarget[0])
        {
            print("Target.ANAMAsry");
            int i = 0;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
                if (LevelManager.THIS.GetIngredients(i).Count < LevelManager.THIS.AnaMasryCountTarget[i])
                {
                    StartCoroutine(FallingCor(square, true));
                    color = 1000 + (int)LevelManager.THIS.trip[i];
                    currentType = ItemsTypes.ANAMASRY;
                    sprRenderer.sprite = AnaMasryItems[i];
                    name = "anaMasry_" + color;
                }
            }
        }
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[1] == ANAMASRY.A || LevelManager.THIS.trip[1] == ANAMASRY.N || LevelManager.THIS.trip[1] == ANAMASRY.M || LevelManager.THIS.trip[1] == ANAMASRY.S || LevelManager.THIS.trip[1] == ANAMASRY.R || LevelManager.THIS.trip[1] == ANAMASRY.Y))
                && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
                && LevelManager.THIS.GetMasry(1).Count < LevelManager.THIS.AnaMasryCountTarget[1])
        {
            int i = 1;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
        ...
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[2] == ANAMASRY.A || LevelManager.THIS.trip[2] == ANAMASRY.N || LevelManager.THIS.trip[2] == ANAMASRY.M || LevelManager.THIS.trip[2] == ANAMASRY.S || LevelManager.THIS.trip[2] == ANAMASRY.R || LevelManager.THIS.trip[2] == ANAMASRY.Y))
               && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
               && LevelManager.THIS.GetMasry(2).Count < LevelManager.THIS.AnaMasryCountTarget[2])
        {
            int i = 2;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
        ...
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[3] == ANAMASRY.A || LevelManager.THIS.trip[3] == ANAMASRY.N || LevelManager.THIS.trip[3] == ANAMASRY.M || LevelManager.THIS.trip[3] == ANAMASRY.S || LevelManager.THIS.trip[3] == ANAMASRY.R || LevelManager.THIS.trip[3] == ANAMASRY.Y))
               && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
               && LevelManager.THIS.GetMasry(3).Count < LevelManager.THIS.AnaMasryCountTarget[3])
        {
            int i = 3;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
        ...
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[4] == ANAMASRY.A || LevelManager.THIS.trip[4] == ANAMASRY.N || LevelManager.THIS.trip[4] == ANAMASRY.M || LevelManager.THIS.trip[4] == ANAMASRY.S || LevelManager.THIS.trip[4] == ANAMASRY.R || LevelManager.THIS.trip[4] == ANAMASRY.Y))
               && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
               && LevelManager.THIS.GetMasry(4).Count < LevelManager.THIS.AnaMasryCountTarget[4])
        {
            int i = 4;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
        ...
        else if ((LevelManager.THIS.target == Target.AnaMasry && (LevelManager.THIS.trip[5] == ANAMASRY.A || LevelManager.THIS.trip[5] == ANAMASRY.N || LevelManager.THIS.trip[5] == ANAMASRY.M || LevelManager.THIS.trip[5] == ANAMASRY.S || LevelManager.THIS.trip[5] == ANAMASRY.R || LevelManager.THIS.trip[5] == ANAMASRY.Y))
               && UnityEngine.Random.Range(0, LevelManager.THIS.Limit) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType
               && LevelManager.THIS.GetMasry(5).Count < LevelManager.THIS.AnaMasryCountTarget[5])
        {
            int i = 5;
            if (LevelManager.THIS.trip[i] == (ANAMASRY)i && LevelManager.THIS.AnaMasryCountTarget[i] > 0)
            {
    ...
    {
        COLORView = color;
        if (currentType != debugType && currentType != ItemsTypes.INGREDIENT && currentType != ItemsTypes.ANAMASRY)
        {
            NextType = debugType;
            ChangeType();
        }
    ...
    IEnumerator Switching()
    {
        if (switchDirection != Vector3.zero && neighborSquare != null)
        {
            ...
            if ((this.currentType == ItemsTypes.BOMB || switchItem.currentType == ItemsTypes.BOMB) && (this.currentType != ItemsTypes.INGREDIENT && switchItem.currentType != ItemsTypes.INGREDIENT) && (this.currentType != ItemsTypes.ANAMASRY && switchItem.currentType != ItemsTypes.ANAMASRY))
                matchesHere++;
            if (this.currentType > 0 && switchItem.currentType > 0)
                matchesHere++;
            if (this.currentType == ItemsTypes.INGREDIENT && switchItem.currentType == ItemsTypes.INGREDIENT || this.currentType == ItemsTypes.ANAMASRY && switchItem.currentType == ItemsTypes.ANAMASRY)
                matchesHere = 0;
            ...
            if (matchesHere <= 0 && matchesInNeithborItem <= 0 && LevelManager.THIS.ActivatedBoost.type != BoostType.Hand ||
                ((this.currentType == ItemsTypes.BOMB || switchItem.currentType == ItemsTypes.BOMB) && (this.currentType == ItemsTypes.INGREDIENT || switchItem.currentType == ItemsTypes.INGREDIENT) && (this.currentType == ItemsTypes.ANAMASRY || switchItem.currentType == ItemsTypes.ANAMASRY) && (matchesHere + matchesInNeithborItem <= 2)) ||
                (((int)this.currentType >= 1 || (int)switchItem.currentType >= 1) && (this.currentType == ItemsTypes.INGREDIENT || switchItem.currentType == ItemsTypes.INGREDIENT) && (this.currentType == ItemsTypes.ANAMASRY || switchItem.currentType == ItemsTypes.ANAMASRY) && (matchesHere + matchesInNeithborItem <= 2)))
            {//1.6.1
            ...
            else
            {
                ...
                if ((this.currentType == ItemsTypes.HORIZONTAL_STRIPPED || this.currentType == ItemsTypes.VERTICAL_STRIPPED) &&
                    (switchItem.currentType == ItemsTypes.HORIZONTAL_STRIPPED || switchItem.currentType == ItemsTypes.VERTICAL_STRIPPED))
                {
                    //1.6
    ...
    void CheckPackageAndPackage(Item item1, Item item2)
    {
        if (item1.currentType == ItemsTypes.PACKAGE && item2.currentType == ItemsTypes.PACKAGE)
        {
            ...
            foreach (Item item in bigList)
            {
                if (item != null)
                {
                    if (item.currentType != ItemsTypes.BOMB && item.currentType != ItemsTypes.INGREDIENT && item.currentType != ItemsTypes.ANAMASRY)
    ...
    {
        if (item1.currentType == ItemsTypes.INGREDIENT || item2.currentType == ItemsTypes.INGREDIENT || item1.currentType == ItemsTypes.ANAMASRY || item2.currentType == ItemsTypes.ANAMASRY)
            return;
    ...
    IEnumerator DestroyCor(bool showScore = false, string anim_name = "", bool explEffect = false)
    {
        ...
        else if (currentType != ItemsTypes.INGREDIENT && currentType != ItemsTypes.BOMB && currentType != ItemsTypes.ANAMASRY)
        {
            PlayDestroyAnimation("destroy");
            // GameObject partcl = Instantiate(Resources.Load("Prefabs/Effects/ItemExpl"), transform.position, Quaternion.identity) as GameObject;
